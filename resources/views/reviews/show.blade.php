    ...
    <div class="min-h-screen bg-gradient-to-b from-gray-900 via-purple-900 to-black text-white">
        ...
        <div class="relative py-20 px-4 hero-bg">
            ...
            <div class="relative max-w-4xl mx-auto">
                ...
                <h1
                    class="text-4xl md:text-6xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-red-600">
                    {{ $review->title }}
                </h1>
        ...
        <div class="max-w-4xl mx-auto px-4 py-16">
            ...
            @if ($review->summary)
                <div class="content-card rounded-lg p-8 mb-12 shadow-2xl">
                    <h2
                        class="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-purple-600">
                        📝 Resumo
                    </h2>
            ...
            <div class="content-card rounded-lg p-8 mb-12 shadow-2xl">
                <h2
                    class="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-red-600">
                    🎯 Avaliação Completa
                </h2>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <ul class="space-y-2 text-gray-300">
                            ...
                            @if ($review->author_director)
                                <li><strong>{{ $review->type === 'book' ? 'Autor' : 'Diretor' }}:</strong>
                                    {{ $review->author_director }}</li>
                            @endif
                            @if ($review->release_year)
            ...
            @if (isset($relatedReviews) && $relatedReviews->count() > 0)
                <div class="content-card rounded-lg p-8 shadow-2xl">
                    <h2
                        class="text-3xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-purple-600">
                        🔗 Reviews Relacionadas
                    </h2>
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @foreach ($relatedReviews as $related)
                            <div
                                class="related-card bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg overflow-hidden shadow-xl border border-gray-700">
                                @if ($related->image_url)
                                    <div class="h-32 bg-cover bg-center"
                                        style="background-image: url('{{ $related->image_url }}')"></div>
                                @endif
                                <div class="p-4">
                                    ...
                                    {{ $related->type === 'movie'
                                        ...
                                        @if ($related->rating)
                                            <div class="flex items-center">
                                                ...
                                                <span
                                                    class="ml-1 text-yellow-400 text-sm font-bold">{{ $related->rating }}/10</span>
                                            </div>
                                        @endif
                                    </div>
